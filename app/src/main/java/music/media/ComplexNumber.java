...
public class ComplexNumber {
    ...
    public static ComplexNumber ComplexNumberPolar(double magnitude, double phase) {
        ComplexNumber c = new ComplexNumber(magnitude * Math.cos(phase) , magnitude * Math.sin(phase));
        return c;
    }
